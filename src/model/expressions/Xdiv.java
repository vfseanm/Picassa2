...
public class Xdiv implements Expression{
	private Expression myOperand1;
    private Expression myOperand2;
    
    public Xdiv (String cmd, ArrayList<Expression> ops)
    {
        if  (ops.size()!=2)
